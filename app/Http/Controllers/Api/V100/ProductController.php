...
class ProductController extends Controller
{
    ...
    public function categoryProducts(Request $request, $id): \Illuminate\Http\JsonResponse
    {
    ...
    public function search(Request $request)
    {
        ...
        $pagination = get_pagination('api_paginate');
        try {
            $products = ProductPaginateResource::collection($this->product->search($key,$pagination));
            
            $categories = CategoryResource::collection($this->category->search($key, $pagination));
