    ...
    public function register(Request $request): \Illuminate\Http\JsonResponse
    {
        try {
            $rules = [
                ...
                //'referred_user_referral_code' => 'sometimes|nullable|exists:user_referral_codes,referral_code',
                //'card_number' => 'sometimes|nullable|max:255|unique:users,card_number',
                // 'socials' => 'required|max:255',
            ];
            
            if(!empty($request->referred_user_referral_code)){
                $rules['referred_user_referral_code'] = 'sometimes|nullable|exists:user_referral_codes,referral_code';
            }
            
            if(!empty($request->card_number)){
                $rules['card_number'] = 'sometimes|nullable|max:255|unique:users,card_number';
            }
            ...
            //disable email verification end
