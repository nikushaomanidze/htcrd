...
class HomeController extends Controller
{
    ...
    public function settingsData(): array
    {
        ...
        $agreements                     = settingData(['seller_agreement', 'customer_agreement','privacy_agreement','refund_policy_agreement','payment_agreement']);
        ...
        $settings = [
            ...
            'lang_file'                         => file_exists(base_path('resources/lang/' . $lang . '.json')) ?  $lang  : 'en',
