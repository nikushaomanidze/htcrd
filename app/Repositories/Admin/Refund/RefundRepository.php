...
{
    use PaymentTrait,SendNotification;
    protected $order;
    protected $wallet;
    protected $seller;
    ...
    public function approvedRefund($id)
    {
            ...
            $this->SendNotification($refund->user,"Your refund request for {$refund->orderDetail->product->product_name} is approved.",'success',"get-invoice/{$refund->order->code}",'');
    ...
    public function payNow($id)
    {
        ...
        try {
            ...
            $this->SendNotification($refund->user,
    ...
    public function rejectRefund($request)
    {
        ...
        try {
            ...
            $this->SendNotification($refund->user,"Your refund request for {$refund->orderDetail->product->product_name} is rejected.",'warning',"get-invoice/{$refund->order->code}",'');
    ...
    public function store($request)
    {
        ...
        $this->SendNotification($refund->seller,"New refund request for {$order_detail->product->product_name}.",'success',"refunds",'');
