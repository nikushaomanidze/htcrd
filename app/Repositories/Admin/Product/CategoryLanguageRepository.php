...
class CategoryLanguageRepository implements CategoryLanguageInterface
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $catLang->category_filter     = $request->category_filter;
            $catLang->number              = $request->number;
            $catLang->soc_fb              = $request->soc_fb;
            $catLang->soc_yt              = $request->soc_yt;
            $catLang->soc_in              = $request->soc_in;
            $catLang->save();
