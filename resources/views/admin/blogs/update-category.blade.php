                        ...
                        <div class="card-body card-body-paddding">
                            ...
                            <form action="{{ route('admin.update.blog.category') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="category_filter"
                                              id="category_filter">{{ old('category_filter') ? old('category_filter') : $category_language->category_filter }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="number">{{ __('Number') }}</label>
                                    <textarea class="form-control" name="number"
                                              id="number">{{ old('number') ? old('number') : $category_language->number }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="soc_fb">{{ __('Facebook') }}</label>
                                    <textarea class="form-control" name="soc_fb"
                                              id="soc_fb">{{ old('soc_fb') ? old('soc_fb') : $category_language->soc_fb }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="soc_yt">{{ __('Youtube') }}</label>
                                    <textarea class="form-control" name="soc_yt"
                                              id="soc_yt">{{ old('soc_yt') ? old('soc_yt') : $category_language->soc_yt }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="soc_in">{{ __('Instagram') }}</label>
                                    <textarea class="form-control" name="soc_in"
                                              id="soc_in">{{ old('soc_in') ? old('soc_in') : $category_language->soc_in }}</textarea>
                                </div>
