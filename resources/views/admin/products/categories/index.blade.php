                            ...
                            <div class="card-body card-body-paddding">
                                <form method="POST" action="{{route('store.categories')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="number" id="number"
                                                  value="{{old('number')}}"
                                                  placeholder="{{__('Number')}}"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="soc_fb" id="soc_fb"
                                                  value="{{old('soc_fb')}}"
                                                  placeholder="{{__('Facebook')}}"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="soc_yt" id="soc_yt"
                                                  value="{{old('soc_yt')}}"
                                                  placeholder="{{__('Youtube')}}"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="soc_in" id="soc_in"
                                                  value="{{old('soc_in')}}"
                                                  placeholder="{{__('Instagram')}}"></textarea>
