                ...
                <div class="card">
                    ...
                    <div class="card-body card-body-paddding">
                        ...
                        <form method="POST" action="{{route('update.categories')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="category_filter">{{__('Category Filter')}}</label>
                                <select class="form-control" name="category_filter" id="category_filter">
                                    <option value="">Select Option</option>
                                    <option value="ტრადიციული" {{ old('category_filter') == 'ტრადიციული' ? 'selected' : '' }}>ტრადიციული</option>
                                    <option value="სუში" {{ old('category_filter') == 'სუში' ? 'selected' : '' }}>სუში</option>
                                    <option value="პიცა" {{ old('category_filter') == 'პიცა' ? 'selected' : '' }}>პიცა</option>
                                    <option value="ზღვის პროდუქტი" {{ old('category_filter') == 'ზღვის პროდუქტი' ? 'selected' : '' }}>ზღვის პროდუქტი</option>
                                    <option value="ბურგერები" {{ old('category_filter') == 'ბურგერები' ? 'selected' : '' }}>ბურგერები</option>
                                    <option value="აზიური" {{ old('category_filter') == 'აზიური' ? 'selected' : '' }}>აზიური</option>
                                    <option value="საცხობი" {{ old('category_filter') == 'საცხობი' ? 'selected' : '' }}>საცხობი</option>
                                    <option value="დესერტი" {{ old('category_filter') == 'დესერტი' ? 'selected' : '' }}>დესერტი</option>
                                    <option value="მქსიკური" {{ old('category_filter') == 'მქსიკური' ? 'selected' : '' }}>მქსიკური</option>
                                    <option value="შაურმა" {{ old('category_filter') == 'შაურმა' ? 'selected' : '' }}>შაურმა</option>
                                    <option value="ვეგეტარიანული" {{ old('category_filter') == 'ვეგეტარიანული' ? 'selected' : '' }}>ვეგეტარიანული</option>
                                </select>
                                @if ($errors->has('category_filter'))
                                    <div class="invalid-feedback">
                                        <p>{{ $errors->first('category_filter') }}</p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="number" id="number" placeholder="{{__('Number')}}">{{$category_language->number}}</textarea>
                            ...
                            <div class="form-group">
                                <label for="soc_fb" >{{__('Facebook')}}</label>
                                <textarea class="form-control" name="soc_fb" id="soc_fb" placeholder="{{__('Facebook')}}">{{$category_language->soc_fb}}</textarea>
                                @if ($errors->has('soc_fb'))
                                <div class="invalid-feedback">
                                    <p>{{ $errors->first('soc_fb') }}</p>
                                </div>
                               @endif
                            </div>

                            <div class="form-group">
                                <label for="soc_yt" >{{__('Youtube')}}</label>
                                <textarea class="form-control" name="soc_yt" id="soc_yt" placeholder="{{__('Youtube')}}">{{$category_language->soc_yt}}</textarea>
                                @if ($errors->has('soc_yt'))
                                <div class="invalid-feedback">
                                    <p>{{ $errors->first('soc_yt') }}</p>
                                </div>
                               @endif
                            </div>

                            <div class="form-group">
                                <label for="soc_in" >{{__('Instagram')}}</label>
                                <textarea class="form-control" name="soc_in" id="soc_in" placeholder="{{__('Instagram')}}">{{$category_language->soc_in}}</textarea>
                                @if ($errors->has('soc_in'))
                                <div class="invalid-feedback">
                                    <p>{{ $errors->first('soc_in') }}</p>
                                </div>
                               @endif
                            </div>
