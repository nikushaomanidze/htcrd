                    ...
                    <ul class="dropdown-menu">
                        ...
                        @if(hasPermission('category_read'))
                            <li class="@yield('category_active')"><a class="nav-link"
                                                                     href="{{ route('categories') }}">{{ __('Restaurants') }}</a>
                            </li>
                        @endif
                        @if(hasPermission('product_create'))
...
{{--                @endif--}}
            ...
            <li class="@yield('other_page')"><a class="nav-link"
                                                href="{{route('other.pages')}}"><i class='bx bx-detail'></i><span>{{ __('All Pages') }}</span></a>
            </li>
                    ...
                    <ul class="dropdown-menu">
                     ...
                     {{--   @if(hasPermission('mobile_app_intro_read'))
                        ...
                        @if(hasPermission('all_page_read') && isAppMode())
                            <li class="@yield('other_page')"><a class="nav-link" href="{{route('other.pages')}}">{{ __('All Pages') }}</a></li>
                        @endif
                        @if(hasPermission('android_setting_update'))
