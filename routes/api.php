...
Route::prefix('v100')->group(function() {
    Route::middleware(['CheckApiKey'])->group(function () {
        ...
        //added by awal
        Route::post('make/direct/order', [OrderController::class, 'makeDirectOrder']);
        
        Route::prefix('user')->middleware(['jwt.verify'])->group(function (){
            //added by awal
            Route::post('referral_users_lists/{user_referral_id}', [UserController::class,'referral_users_lists']);
            Route::post('total_referral_users/{user_referral_id}', [UserController::class,'total_referral_users']);
            Route::post('total_active_referral_users/{user_referral_id}', [UserController::class,'total_active_referral_users']);
            Route::post('update_card_number/{user_id}', [UserController::class,'update_card_number']);
            Route::post('update_balance_value/{user_id}', [UserController::class,'update_balance_value']);
            Route::post('make_card_active/{user_id}', [UserController::class,'make_card_active']);
