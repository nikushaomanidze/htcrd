...
class AppThemeData {
  ...
  static const Color lightBackgroundColor = Color(0xffe07527);
  ...
  static final profileTextStyle_13 = TextStyle(
      color: const Color(0xff666666), fontFamily: "BPG", fontSize: 13.sp);
  static final profileTextStyle_10Tab = TextStyle(
      color: const Color(0xff666666), fontFamily: "BPG", fontSize: 10.sp);
  static final favoriteTextStyle_14 = TextStyle(
      color: const Color(0xff666666), fontFamily: "BPG", fontSize: 14.sp);
  static final paymentTypeTextStyle_13 = TextStyle(
      color: const Color(0xff56A8C7), fontFamily: "BPG", fontSize: 13.sp);
  static final paymentTypeTextStyle_12 = TextStyle(
      color: const Color(0xff56A8C7), fontFamily: "BPG", fontSize: 12.sp);
  static final paymentStatusTextStyle_13 = TextStyle(
      color: const Color(0xff6DBEA3), fontFamily: "BPG", fontSize: 13.sp);
  static final walletTextStyle_12 = TextStyle(
      color: const Color(0xff666666), fontFamily: "BPG", fontSize: 12.sp);
  static final walletTextStyle_10Tab = TextStyle(
      color: const Color(0xff666666), fontFamily: "BPG", fontSize: 10.sp);
  static final addLocationTextStyle_13 = TextStyle(
      color: const Color(0xff0EA5DE), fontFamily: "BPG", fontSize: 13.sp);
  static final addAddressTextStyle_13 = TextStyle(
      color: const Color(0xff56A8C7), fontFamily: "BPG", fontSize: 13.sp);
  static final addAddressTextStyle_10Tab = TextStyle(
      color: const Color(0xff56A8C7), fontFamily: "BPG", fontSize: 10.sp);
  static final hintTextStyle_13 = TextStyle(
      color: const Color(0xff999999), fontFamily: "BPG", fontSize: 13.sp);
  static final hintTextStyle_10Tab = TextStyle(
      color: const Color(0xff999999), fontFamily: "BPG", fontSize: 10.sp);
