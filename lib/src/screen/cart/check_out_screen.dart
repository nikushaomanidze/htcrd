            ...
            body: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      '${AppTags.youWillSave.tr}${currencyConverterController.convertCurrency(widget.addToCartListModel!.data!.calculations!.formattedTotal.toString())} ${AppTags.lars.tr}',
                  ...
                  Center(
                    child: Text(
                      '${AppTags.youHaveSaved.tr}${currencyConverterController.convertCurrency(myWalletController.myWalletModel.value.data!.balance!.balance != null ? myWalletController.myWalletModel.value.data!.balance!.balance!.toStringAsFixed(3) : "0")} ${AppTags.lari.tr}',
                      style: const TextStyle(fontSize: 17),
                    ),
                  ),
                  Expanded(
