...
class _HomeScreenContentState extends State<HomeScreenContent> {
  ...
  Widget topCategories(topCategoriesIndex, context) {
    ...
    // List<data_model.TopCategories> sortTopCategories = [];
    homeScreenContentController
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var a = 0.5 -
                    cos((double.parse(homeScreenContentController.homeDataModel.value.data![topCategoriesIndex].topCategories![index].latlong!.split(",")[0]) - provider.position!.latitude) * p) /
                        2 +
