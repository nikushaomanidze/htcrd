      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount:
                visitShopModel!.data!.store![brandIndex].popularBrands!.length,
            itemBuilder: (context, index) {
              return Padding(
                padding: EdgeInsets.only(right: 15.w),
                child: InkWell(
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) => ProductByBrand(
                          id: visitShopModel!.data!.store![brandIndex]
                              .popularBrands![index].id!,
                          title: visitShopModel!.data!.store![brandIndex]
        ...
        children: [
          SizedBox(
            ...
            child: ListView.builder(
              ...
              scrollDirection: Axis.horizontal,
              itemCount:
                  visitShopModel!.data!.store![bannerIndex].banners!.length,
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () {
                    var data = visitShopModel!
                        .data!.store![bannerIndex].banners![index];
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.cover,
                            image: CachedNetworkImageProvider(visitShopModel!
                                .data!
                                .store![bannerIndex]
                                .banners![index]
                                .thumbnail!
